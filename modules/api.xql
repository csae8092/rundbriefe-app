...
module namespace api="http://www.digital-archiv.at/ns/salzarchiv/api";
declare namespace rest = "http://exquery.org/ns/restxq";
declare namespace tei = "http://www.tei-c.org/ns/1.0";
import module namespace functx = "http://www.functx.com";
import module namespace app="http://www.digital-archiv.at/ns/salzarchiv/templates" at "app.xql";
import module namespace config="http://www.digital-archiv.at/ns/salzarchiv/config" at "config.xqm";
...
declare 
    %rest:GET
    %rest:path("/salzarchiv/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/salzarchiv/dt/{$collection}/{$format}")
...
declare 
    %rest:GET
    %rest:path("/salzarchiv/{$collection}/{$id}/{$format}")
